...
while($arr_tovar = mysqli_fetch_assoc($get_tovar)){
    ...
    <div style="color:#C99E71; margin-right: 5px;">'.$arr_tovar['price'].'$
       <br><button onclick="addck('.$arr_tovar['id'].')" id="'.$arr_tovar['id'].'" class="buttonbuy"><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
